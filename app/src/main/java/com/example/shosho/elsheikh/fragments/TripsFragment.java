...
import com.example.shosho.elsheikh.adapter.TripsAdapter;
 ...
 */
public class TripsFragment extends Fragment implements BookView,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById( R.id.trips_recycler_items );
        networkConnection=new NetworkConnection( getContext() );
        mSwipeRefreshLayout=view.findViewById( R.id.trips_swipRefresh );
        bookPresenter=new BookPresenter( getContext(),this );
        bookPresenter.getBooksResult( "ar","trips" );
    ...
    public void showBooksData(List<BookData> booksData) {
        tripsAdapter = new TripsAdapter( getContext(), booksData );
